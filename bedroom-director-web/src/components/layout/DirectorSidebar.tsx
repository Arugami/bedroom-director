...
import { ChevronLeft, ChevronRight, Film, Image, Mic, Music, Clock, Heart, TrendingUp, Sparkles, Filter } from "lucide-react";
...
export default function DirectorSidebar({
  ...
  return (
    <aside
      className={`${getWidth()} flex-shrink-0 transition-all duration-300 ease-in-out relative`}
    >
      {/* Sidebar Container */}
