...
- **Source of Truth:** `notes/trending-ads.md` (editorial log) + `data/ai_video_image_models.csv` (model metadata).
...
## 3. Content Workflow
1. **Research & Logging:** Add new campaigns to `notes/trending-ads.md` with sources and tool breakdowns.
